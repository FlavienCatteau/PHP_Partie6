...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice5P6</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 5 partie 6</h1>
                <p class="lead text-center">Faire une page index.php. Tester sur cette page que tous les paramètres de cette URL existent et les afficher: index.php?week=12</p>
            </div>
        ...
        <main>
            <div class="php text-center">
                <a href="index.php?week=12"><button>Afficher</button></a><br/>
                <?php
                if (isset($_GET['week'])) { // On a la semaine
                    echo 'On est la ' . $_GET['week'] . ' semaine de l\'année ' . ' !';
